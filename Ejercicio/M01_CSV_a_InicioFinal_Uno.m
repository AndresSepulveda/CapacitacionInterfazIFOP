...
%file_prefix=['All_IDia_1-10_AV_720_Lapa'];
file_prefix=['All_IMes_Ancud_720_Lapa'];
%file_prefix=['All_IDia_Coquimbo_1-10_720_Lapa_4m'];

skip=10;  
radius=2000;  % min distance for conectivity
